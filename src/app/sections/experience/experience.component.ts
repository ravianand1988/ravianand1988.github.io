  ...
  entries: ExperienceEntry[] = [
    {
      ...
      bullets: [
        ...
        'Led frontend architecture and technical direction for a B2B logistics platform serving 500+ customers and processing 100,000+ orders/month, with peak load during Black Friday and Christmas',
        'Managed and mentored a team of 4-6 frontend engineers — hiring, onboarding, and performance guidance',
        ...
        'Automated the GitHub release/deployment tagging process and owned CI/CD pipelines (GitHub → CI/CD → Docker → AWS)',
